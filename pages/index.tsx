...
const Home: NextPage = () => {
    ...
    return (
        <div className=''>
            <div className="relative bg-[url('/icons/bg_wave.svg')] overflow-hidden pb-12">
                <div className='mx-auto max-w-7xl'>
                    <Head>
                        <title>Fist</title>
                        {/* <link rel="icon" href="/favicon.ico" /> */}
                    </Head>
                    <div className='relative z-10 bg-transparent pb-8 sm:pb-16 md:pb-20 xl:w-full xl:max-w-2xl xl:pb-28'>
                        <Header title='Log in' href='/login' />
                        <Hero />
                    </div>
                </div>
                <div
                    className='xl:absolute xl:inset-y-0 xl:right-0 xl:w-1/2 xl:block hidden'
                    data-aos='fade-down'
                >
                    <img
            ...
            <section className='pt-10 pb-10'>
                <div className='mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8'>
                    <h2
                        className='text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-200 sm:text-4xl'
                        data-aos='fade-right'
                    >
            ...
            <footer className='py-12 px10 bg-slate-800'>
                <div className='mx-auto max-w-7xl'>
                    <div className='grid grid-cols-2 gap-8 md:grid-cols-4'>
                        <div className='p-5 max-w-sm'>
                            <img src='../icons/logo.svg' alt='logo' />
                            <p className='font-normal text-slate-400 mt-4'>
                                Save your time, increase your wallet frequently.
                                Start your day better.
                            </p>
                        </div>
                        <div className='p-5 max-w-sm'>
                            <h5 className='font-semibold text-slate-400 dark:text-slate-100'>
                                Solutions
                            </h5>
